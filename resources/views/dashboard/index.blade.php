                ...
                <div x-show="activeTab === 'otp'"
                    ...
                    <div class="pt-2 text-center">
                        <a href="{{ route('otp-orders.index') }}"
                           class="inline-flex items-center gap-2 rounded-xl border border-brand-200 bg-brand-50/80 px-5 py-2.5 text-xs font-bold text-brand-900 transition hover:bg-brand-100 hover:border-brand-300">
                            <span>Buka Halaman Lengkap Riwayat OTP & Filter</span>
                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
